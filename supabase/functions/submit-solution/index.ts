...
Deno.serve(async req=>{const pre=handleOptions(req);if(pre)return pre;try{return json(await execute(await requireAuth(req),await req.json(),'submit'))}catch(e){return errorResponse(e)}});
